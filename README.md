...
- [zifter/textfile-exporter](https://github.com/zifter/textfile-exporter) - Export metrics from text filee (6 days ago)
- [zifter/u-trust-bot](https://github.com/zifter/u-trust-bot) - Telegram Personal Assistent (1 month ago)

#### 🔨 My recent Pull Requests

- [Prepare release 0.10.0](https://github.com/zifter/clickhouse-migrations/pull/43) on [zifter/clickhouse-migrations](https://github.com/zifter/clickhouse-migrations) (6 days ago)
- [Update Go to 1.24, fix code issues, add detailed README](https://github.com/zifter/textfile-exporter/pull/1) on [zifter/textfile-exporter](https://github.com/zifter/textfile-exporter) (6 days ago)
- [Add star history chart to README](https://github.com/zifter/clickhouse-migrations/pull/42) on [zifter/clickhouse-migrations](https://github.com/zifter/clickhouse-migrations) (6 days ago)

#### 🚀 Latest releases I've contributed to
- [zifter/clickhouse-migrations v0.10.0](https://github.com/zifter/clickhouse-migrations/releases/tag/v0.10.0) (6 days ago)
- [zifter/u-trust-bot v0.7.0](https://github.com/zifter/u-trust-bot/releases/tag/v0.7.0) (6 months ago)
- [zifter/textfile-exporter v0.0.4](https://github.com/zifter/textfile-exporter/releases/tag/v0.0.4) (1 year ago)
...
- [Managing ClickHouse Migrations in Production: Cluster Support and Multi-Statement Files](https://medium.com/@zifter/managing-clickhouse-migrations-in-production-cluster-support-and-multi-statement-files-07d46c1de275?source=rss-766601af1f16------2) (6 days ago)
